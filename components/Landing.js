...
import Landingimg from "../images/7197355.jpg";
          ...
          >
            ...
            > */}
              <div className="d-flex flex-column justify-content-center align-items-center  ">
                <Typed
                  strings={[
                    "Find your perfect ride at Rent-O-Car.",
                    "Hassle-free Booking with us.",
                    "Explore our diverse fleet for every need.",
                    "Competitive rates, exceptional service.",
                    "Drive with confidence, reserve today!",
                  ]}
                  typeSpeed={60}
                  backSpeed={10}
                  className="typed"
